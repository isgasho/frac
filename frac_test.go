...
func TestParseDec(t *testing.T) {
	t.Run(`invalid`, func(*testing.T) {
		testParseDecErr(``, `empty input`, 0, 1, 2)
		testParseDecErr(` `, `non-digit character`, 0, 1, 2)
		testParseDecErr(` 12`, `non-digit character`, 0, 1, 2)
		testParseDecErr(`12 `, `non-digit character`, 0, 1, 2)
		testParseDecErr(`12.`, `unexpected end of input`, 0, 1, 2)
		testParseDecErr(`.12`, `non-digit character`, 0, 1, 2)
		testParseDecErr(`+`, `unexpected end of input`, 0, 1, 2)
		testParseDecErr(`-`, `unexpected end of input`, 0, 1, 2)
		testParseDecErr(`+.12`, `non-digit character`, 0, 1, 2)
		testParseDecErr(`-.12`, `non-digit character`, 0, 1, 2)
		testParseDecErr(`--12`, `non-digit character`, 0, 1, 2)
	...
	t.Run(`int`, func(*testing.T) {
		...
		testParseDecErr(maxInt64+`0`, `overflow`, 0, 1, 2, 3)
		testParseDecErr(minInt64+`0`, `underflow`, 0, 1, 2, 3)
	})

	t.Run(`frac`, func(*testing.T) {
		testParseDecErr(`01230.04560`, `exponent exceeds`, 0, 1, 2, 3)
		testParseDecErr(`+01230.04560`, `exponent exceeds`, 0, 1, 2, 3)
		testParseDecErr(`-01230.04560`, `exponent exceeds`, 0, 1, 2, 3)
		...
		testParseDecErr(maxInt64+`.1`, `overflow`, 1, 2, 3)
		testParseDecErr(minInt64+`.1`, `underflow`, 1, 2, 3)
	})
}

func TestParseBin(t *testing.T) {
	t.Run(`invalid`, func(*testing.T) {
		testParseBinErr(`2`, `non-digit character`, 0)
	})
	...
	t.Run(`frac`, func(*testing.T) {
		testParseBinErr(`010101.01010`, `exponent exceeds`, 0, 1, 2, 3)
		testParseBinErr(`+010101.01010`, `exponent exceeds`, 0, 1, 2, 3)
		testParseBinErr(`-010101.01010`, `exponent exceeds`, 0, 1, 2, 3)
...
func TestParseHex(t *testing.T) {
	t.Run(`invalid`, func(*testing.T) {
		testParseHexErr(`g`, `non-digit character`, 0)
	})
	...
	t.Run(`frac`, func(*testing.T) {
		testParseHexErr(`0f0f0f.0f0f0`, `exponent exceeds`, 0, 1, 2, 3)
		testParseHexErr(`+0f0f0f.0f0f0`, `exponent exceeds`, 0, 1, 2, 3)
		testParseHexErr(`-0f0f0f.0f0f0`, `exponent exceeds`, 0, 1, 2, 3)
...
func testParseBinErr(src string, msg string, fracs ...uint) {
	testParseErr(src, msg, 2, fracs...)
}

func testParseDecErr(src string, msg string, fracs ...uint) {
	testParseErr(src, msg, 10, fracs...)
}

func testParseHexErr(src string, msg string, fracs ...uint) {
